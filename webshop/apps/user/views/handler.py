...
from WebShop.apps.user.forms import RegisterForm, AccountForm, AddressForm, OrderFreeCatalogForm, ValidationError
...
def login(request):
    ...
    if not email and not password:
        map['studio'] = request.REQUEST.get('studio', '')
    ...
    if user is not None:
        if user.is_active:
            ...
            map['error'] = mark_safe(_('Sorry, please activate your account.'))
    else:
        map['error'] = mark_safe(_('Sorry, please check your email and password.'))
    if success:
